...
public class CalculadoraCientifica {
    ...
    // Metodo para mostrar resultados almacenados
    ...
    // Metodo recursivo para el cálculo de la potencia
    public static double potenciaRecursiva(double base, int exponente) {
        if (exponente == 0) {
            return 1; // Caso base: cualquier número elevado a 0 es 1
        }
        if (exponente < 0) {
            return 1 / potenciaRecursiva(base, -exponente); // Manejo de exponentes negativos
        }
        return base * potenciaRecursiva(base, exponente - 1); // Recursión
    }
}
    ...
    private void realizarOperacion(int opcion) {
        ...
        switch (opcion) {
            ...
            case 5 -> {
                ...
                resultado = CalculadoraCientifica.potenciaRecursiva(num1, (int) num2);
